            ...
            <form method="POST" action="{{ route('klanten.update', ['klantId' => $klant->id]) }}" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <select id="aanwezigheidsstatus" name="aanwezigheidsstatus" class="form-select" required>
                        <option value="binnen_land" @selected(old('aanwezigheidsstatus', $klant->aanwezigheidsstatus) === 'binnen_land')>Binnen land</option>
                        <option value="buiten_land" @selected(old('aanwezigheidsstatus', $klant->aanwezigheidsstatus) === 'buiten_land')>Buiten land</option>
                        <option value="afwezig" @selected(old('aanwezigheidsstatus', $klant->aanwezigheidsstatus) === 'afwezig')>Afwezig</option>
                    </select>
